...
import io.github.portlek.configs.files.yaml.YamlConfigurationOptions;
...
public class CommentDumper extends CommentReader {
    ...
    public CommentDumper(@NotNull final YamlConfigurationOptions options, @NotNull final CommentMapper commentMapper,

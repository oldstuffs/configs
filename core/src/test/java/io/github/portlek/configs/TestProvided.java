...
public final class TestProvided implements Provided<ProvidedObject> {
    ...
    @Override
    public void set(@NotNull final ProvidedObject providedObject, @NotNull final ConfigSection section,
    ...
    @NotNull
    @Override
    public Optional<ProvidedObject> get(@NotNull final ConfigSection section, @NotNull final String path) {
